...
import { X, Download, Upload, Database, CheckCircle2, AlertTriangle, RefreshCw, Sparkles } from 'lucide-react';
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="p-4 border border-red-200 rounded-xl bg-red-50/50 flex items-center justify-between">
            ...
            <button
              ...
              disabled={isProcessing}
              className="px-4 py-2 bg-rose-700 hover:bg-rose-600 text-white text-xs font-bold rounded-xl shadow-xs transition flex items-center gap-1.5 shrink-0 cursor-pointer"
            >
